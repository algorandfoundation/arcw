...
use arcw_lint::reporters::count::Count;
use arcw_lint::reporters::{Json, Reporter, Text};
use arcw_lint::{default_lints, Linter};
...
impl Reporter for EitherReporter {
    fn report(&self, snippet: Snippet<'_>) -> Result<(), arcw_lint::reporters::Error> {
        match self {
